=== Coupon Manager & Reporting Lite for WooCommerce ===
Contributors: redefiningtheweb
Donate link: https://redefiningtheweb.com
Tags: woocommerce order coupon, woocommerce coupon generator, woocommerce upto discount,coupons, coupon, order coupon, apply coupon on order, apply coupon, placed order coupon 
...
WooCommerce Order Coupon plugin provides enhanced coupon facility to the customer. By using this customer can apply the coupon on placed order if they have forgotten to apply coupon at the time of checkout.
...
Make a smart move with [WooCommerce Order Coupon Pro](https://codecanyon.net/item/woocommerce-order-coupon-pro/23642976)
...
= For Premium Plugin you can [visit here](https://codecanyon.net/item/woocommerce-order-coupon-pro/23642976).


== Screenshots ==

1. Admin settings of the plugin.
2. Coupon applies box for placed order.
3. Applyed coupon discount and list of applyed coupons.
...
* **Our Facebook Profile** – [https://www.facebook.com/redefiningtheweb/](https://www.facebook.com/redefiningtheweb/)
* **Our Twitter Profile** – [https://twitter.com/WebRedefining/](https://twitter.com/WebRedefining/)
* **Our Linkedin Profile** – [https://www.linkedin.com/company/redefiningtheweb/](https://www.linkedin.com/company/redefiningtheweb/)
...
The manual installation method involves downloading our WooCommerce Order Coupon and uploading it to your web server via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](http://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
